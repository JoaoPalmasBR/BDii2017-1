 ...
 * 
 */
public class telaRelatorioVeiculos extends javax.swing.JInternalFrame {
    ...
    public void gerarRelatorioVeiculos(){
        ...
        if(veiculos.isEmpty()){
            ...
            for(Veiculo v: veiculos){
                String[] linha= {v.getCodVeiculo()+"",v.getTipoVeiculo(),
                    v.getModeloVeiculo(),v.getMarcaVeiculo(),v.getCorVeiculo(),
                    v.getPlacaVeiculo(),v.getRenavamVeiculo(),
                    v.getVencimentoVeiculo(),v.getCategoriaVeiculo(),
                    v.getObservacoesVeiculo()};
                modelo.addRow(linha);
            }
    }
